<div class="player_card_grid" style="display: none" id="player_<?= $playerTempId ?>_card">
    <div class="player_card_grid_intro">
        <div class="player_card_intro_div">
            <a href="<?= WEBROOT ?>User/player/<?= $player->getId() ?>"><span class="player_card_pseudo"><?= $player->getUserPseudo() ?></span></a>
            <span class="player_card_reputation_stars"><?= $player->getUserReputationStars() ?></span>
        </div>
    </div>
    <div class="player_card_grid_avatar">
        <?php require (ROOT."public/php/avatars/player_avatar_image.php"); ?>
    </div>
    ...
    <div class="player_card_grid_footer">
        <a href="<?= WEBROOT ?>User/messages" ><button class="player_card_buttons normal">Message</button ></a>
